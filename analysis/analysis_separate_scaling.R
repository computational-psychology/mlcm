## Analysis of MLCM data separatedely for within and across context comparisons
...
rootname = paste('parsed_results/', obsname, '_reindexed','_subset_', '1-2', sep = '')
...
# full MLCM
# reads data
fname <- paste('parsed_results/', obsname, '_reindexed', '.csv', sep = "")
